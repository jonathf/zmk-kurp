#include "helper.h"
// HOST_OS: 0 iso, 1 linux, 2 macos unicode
...
ZMK_PAIR(_COMMA_SEMI, COMMA, LCTRL, _0_SEMI)
#define _COMMA &_COMMA_SEMI

#define _0_COLON COLON
#define _2_COLON LS(DOT)
ZMK_PAIR(_DOT_COLON, DOT, LALT, _0_COLON)
#define _DOT &_DOT_COLON

#define _0_FSLH FSLH
#define _0_BSLH BSLH
ZMK_PAIR(_FSLH_BSLH, _0_FSLH, RALT, _0_BSLH)
